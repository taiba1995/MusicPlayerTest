...
public class Registration extends Activity{
	...
	EditText password,repassword,securityhint,e;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				boolean flag = isValidate(email,Pass,Repass,Secu);
				if(flag == false)
				{
				...
				else
				{
				    ...
				    loginDataBaseAdapter.insertEntry(email, Pass, Repass,Secu);
	...
	private boolean isValidate(String email, String pass, String repass, String secu) {

		boolean flag = true;
		if (email.isEmpty() || !android.util.Patterns.EMAIL_ADDRESS.matcher(email).matches() ) {
			Toast.makeText(Registration.this, "Please Validate Your email ", Toast.LENGTH_LONG).show();
			flag = false;
		}
		if (pass.isEmpty() || pass.length() < 4 || pass.length() > 10) {
			Toast.makeText(Registration.this, "Please Validate Your Password", Toast.LENGTH_LONG).show();
			flag = false;
		}
		...
		if(email.equals("")||pass.equals("")||repass.equals("")||secu.equals(""))
		{
